...
// NOTE: Admin user management (list, view, edit role/access, the admin-role
// email-OTP promotion flow, admin address edit/delete, deactivate) lives in the
// separated admin namespace: server/routes/admin/adminUserRoutes.js (mounted at
// /api/admin/users). This router serves only public auth and the logged-in
// user's own profile/addresses.
